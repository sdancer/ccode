...
// Lines: 419686-419761
//
var trackPostpone = U((bnZ, RP2)=>{
    RP2.exports = function(Q, B, G) {
        ...
        var F = B == "maxProperties" ? ">" : "<";
        if (((Z += "if ( "), H)) Z += " (" + D + " !== undefined && typeof " + D + " != 'number') || ";
        Z += " Object.keys(" + V + ").length " + F + " " + D + ") { ";
        var E = B, z = z || [];
        if ((z.push(Z), (Z = ""), Q.createErrors !== !1)) {
            if (((Z += " { keyword: '" + (E || "_limitProperties") + "' , dataPath: (dataPath || '') + " + Q.errorPath + " , schemaPath: " + Q.util.toQuotedString(W) + " , params: { limit: " + D + " } "), Q.opts.messages !== !1)) {
